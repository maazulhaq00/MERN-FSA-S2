...
export default function ApprovedScheduleRegistrations() {
  ...
  const fetchApproved = async () => {
    try {
      ...
      console.error("Error fetching approved schedule registrations:", err);
    }
  };
  ...
  return (
    <Card elevation={3} sx={{ pt: 2, mb: 3, ml: 4, mr: 4, mt: 5 }}>
      <CardHeader>
        <Title>Approved Schedule Registrations</Title>
      </CardHeader>
