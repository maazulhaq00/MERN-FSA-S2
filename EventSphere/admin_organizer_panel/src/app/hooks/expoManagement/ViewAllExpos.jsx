...
// export default function ViewAllAdminExpos() {
...
//   const calculateStatus = (expoDate) => {
//   const today = new Date();
//   today.setHours(0, 0, 0, 0);

//   const date = new Date(expoDate);
...
//     selectedStatus === "all"
//       ? expos
//       : expos.filter((expo) => calculateStatus(expo.date) === selectedStatus);

//   const OnhandleDeleteButton = async (id) => {
//     await axios.delete(`http://localhost:1308/expo/${id}`);
//     fetchData();
//   };

//   const OnhandleUpdateButton = async (id) => {
//     navigate(`/dashboard/updateexpos/${id}`);
//   };
...
//           <MenuItem value="ongoing">Ongoing Expo</MenuItem>
...
//     style={{
//       color:
//         calculateStatus(expo.date) === "ongoing"
//           ? palette.warning.main
//           : calculateStatus(expo.date) === "past"
//           ? palette.error.main
//           : palette.success.main,
//       fontWeight: 500
//     }}
//   >
//     {calculateStatus(expo.date)}
//   </span>
// </Typography>
...
//                     size="small"
//                     color="primary"
//                     onClick={() => OnhandleUpdateButton(expo._id)}
//                   >
//                     Update
//                   </Button>
//                   <Button
...
//                     size="small"
//                     color="error"
//                     onClick={() => OnhandleDeleteButton(expo._id)}
//                   >
//                     Delete
//                   </Button>
//                 </CardActions>
            ...
            <Grid item xs={12} sm={6} md={4} key={expo._id}>
              <Card sx={{ maxWidth: 345, display: "flex", flexDirection: "column", height: "100%" }}>
                ...
                <Box
                  ...
                  onClick={() => navigate(`/dashboard/expo/${expo._id}`)}
                >
                  <CardMedia
                    component="img"
                    height="140"
